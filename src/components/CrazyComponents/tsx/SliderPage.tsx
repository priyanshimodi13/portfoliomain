...
// Preloader removed — renders immediately for fast load
...
export default function SliderPage() {
    ...
    useEffect(() => {
        ...
        const loadTextures = async () => {
            ...
            try {
                ...
                animate();
                setLoaded(true); // Show immediately once textures are ready
        ...
        // Tweakpane removed for production performance
    ...
    return (
        <main
            ref={containerRef}
            className={`relative w-full h-full overflow-hidden bg-black text-white font-sans transition-opacity duration-500 ${loaded ? 'opacity-100' : 'opacity-0'}`}
            onClick={(e) => {
