...
function VelocityText({
  ...
  if (typeof children === 'string' && children.includes('•')) {
    ...
    renderedContent = (
      <span className="scroll-velocity-item-group" style={{ display: 'inline-flex', alignItems: 'center' }}>
        {items.map((item, idx) => (
          <React.Fragment key={idx}>
            <span className="scroll-velocity-skill">{item}</span>
            <span className="scroll-velocity-bullet">•</span>
          </React.Fragment>
        ))}
      </span>
    );
